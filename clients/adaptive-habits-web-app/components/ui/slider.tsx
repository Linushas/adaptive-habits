  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          "bg-bg-light-2 relative grow overflow-hidden rounded-full data-[orientation=horizontal]:h-8 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5"
        )}
      >
